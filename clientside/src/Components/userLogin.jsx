...
const UserLP = () => {
    ...
    const login = () => {
        ...
        .then((res)=>res.data == true ? nav("/homepage",{state:{username:username}}) : window.alert("Either username or password or both are wrong"))
        ...
        <>
            <section className="login-wrapper">
                <div className="input-container">
                    ...
                    <button onClick={() => nav("/userLogin")}>NEW USER ?</button>
                </div>
            </section>
        </>
    )
